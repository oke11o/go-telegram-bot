...
type Repo interface {
	...
	TournamentOpenedAll(ctx context.Context) ([]model.Tournament, error)
	TournamentOpenedByManager(ctx context.Context, userID int64) ([]model.Tournament, error)
	TournamentStart(ctx context.Context, id int64) error
	TournamentFinish(ctx context.Context, id int64) error
}
